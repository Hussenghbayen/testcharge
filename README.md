...
حسين عزات حسين غباين	Flutter / Frontend	مثال: شاشات المصادقة، Router
حسين عزات حسين غباين	Flutter / State Management	مثال: Cubits، ApiClient
محمود ماضي	Backend	مثال: API، قاعدة البيانات، صلاحيات الوصول
محمد مهدي	UI/UX + اختبارات	مثال: Figma، الاختبارات الآلية
---
التقنيات المستخدمة
...
---
صور من التطبيق
> ⚠️ https://youtu.be/iguguW1MXZ4?si=fzgb-69zMvDSYn_Y>
> ```markdown
...
روابط المشروع
العنصر	الرابط
مستودع الباك اند	https://github.com/MohammEdeyad2001/Final-report-.git
الباك اند (بيئة التشغيل)	`https://charging-api-tkne.onrender.com`
تقرير التخرج (PDF/Doc)	
ملف Figma	https://www.figma.com/design/z7EdLLqHxaxUXPiHqY20FK/Untitled?node-id=0-1&t=YXqLUUKe2LHnxRhx-1
---
تاريخ التطوير و Git
